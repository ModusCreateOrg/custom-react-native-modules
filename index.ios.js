...
const { MCFileWriterManager } = NativeModules;
...
class CustomComponent extends Component {
  ...
  onSavePress = () => {
    const fileName     = this.textInputValue,      // What file name to write?
          fileContents = Math.random().toString(); // This goes into the file

    MCFileWriterManager.writeFile(
      fileName,
      fileContents,
      // errorCallback
      (results) => {
      ...
      // successCallback
      (results) => {
        const resultsText = 'Saved to ' + fileName + '. Press load to see contents.';
  ...
  onLoadPress = () => {
    ...
    const fileName = this.textInputValue;
    
    MCFileWriterManager.readFile(
      fileName,                     
      //errorCallback
      (results) => {
        alert('Error: ' + results.errMsg);
      ...
      // successCallback
      (results) => {
        const resultsText = 'Contents of ' + fileName + ': ' + results.contents;
...
AppRegistry.registerComponent('CustomModule', () => CustomComponent);
